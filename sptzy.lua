...
local currentId = ""
local searchMode = "10" -- Default: Model (10). Audio (3).
...
WelcomeMsg.Text = "Pilih mode, ketik keyword, lalu tekan Enter."
...
ModeBtn.MouseButton1Click:Connect(function()
    if searchMode == "10" then
        searchMode = "3"; ModeBtn.Image = "rbxassetid://10734951121"; ModeBtn.BackgroundColor3 = Color3.fromRGB(255, 170, 0); PageIndicator.Text = "MODE: AUDIO"; PageIndicator.TextColor3 = Color3.fromRGB(255, 170, 0)
    else
        searchMode = "10"; ModeBtn.Image = "rbxassetid://10734950309"; ModeBtn.BackgroundColor3 = Color3.fromRGB(0, 170, 255); PageIndicator.Text = "MODE: MODEL"; PageIndicator.TextColor3 = Color3.fromRGB(0, 170, 255)
    end
end)
